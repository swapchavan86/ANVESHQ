...
class MomentumStock(Base):
    ...
    stop_loss_pct: Mapped[float] = mapped_column(Float, default=-8.0, nullable=False, server_default="-8.0")
    take_profit_pct: Mapped[float] = mapped_column(Float, default=15.0, nullable=False, server_default="15.0")
